...
def integration_tab(x, Y, names, x_col, clean_params, src_name):
    st.caption("Auto-detected windows appear as shaded bands. "
               ...
               "precise placement; or fine-tune exact bounds below.")
